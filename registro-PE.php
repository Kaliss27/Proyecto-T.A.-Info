...
<html>
 ...
 <body onload="dropdownFu()">
  <div class="sidenav">
            ...
            <button class="dropdown-btn active">Programas Educativos 
                <i class="fa fa-caret-down"></i>
            </button>
            <div class="dropdown-container">
                <div class="active"><a href="#">Registro PE</a></div>
            ...
            <div id="contenido">
                <form>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type=text name="idPE" placeholder="Clave"><br>
                      </td>
                    </tr>
                    <tr>
                      <td>
                  ...
                  <?php
                    if (isset($_POST['enviar'])){
                      require("OnlyPHP/registroPE.php"); 
                    }
                  ?>
                </form>
            </div>
